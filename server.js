...
const tablajojosRouter=require ('./routes/tablajojos')
class Server {
    constructor(){
        ...
        this.tablajojosPath = `${this.basePath}/tablajojos`;//Path para la tabla users
    ...
    routes(){
        this.app.use(this.tablajojosPath, tablajojosRouter); //EndPoint de users ver que pex
    }
